...
final_all_scenarios <- foreach(
  ...
  file_name <- paste0("results_scen_", scenario, "_n", params$n, "_err_", params$error, "_parallel.csv")
...
write.csv(final_all_scenarios, here::here("results/FINAL_SUMMARY_TABLE_parallel.csv"), row.names = FALSE)
